...
const { registerPrivateEquityHandlers, startPrivateEquityLoop } = require("./privateEquity");
...
io.on("connection", socket => {
  ...
  registerPrivateEquityHandlers(io, socket, gameState);
});
...
startPrivateEquityLoop(io, gameState);
